...
/**
 * 其实我一直觉得叫“BlockItem”更合适，明明是Item非要叫Block
 */
public class ItemBlockBase extends ItemBlock
{
    public ItemBlockBase(BlockBase blockBase)
    {
        super(blockBase);
...
//        }
        ...
        if (hasSubBlocks) {
            super.setMaxDamage(0);    //The item can not be damaged
        }

        this.setRegistryName(blockBase.getRegistryName());
    }

    /**
     * 获取此物品的非本地化名称。接受一个ItemStack的原因在{@link ItemBase}中解释过，
     * 但是对于方块物品来说不太可能有损坏值，可能是物品堆的其他属性吧
     *
     * @param itemStack 物品堆
     */
    @Override
